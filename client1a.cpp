...
void * thread_routine(void * thread_id) {
        ...
        if (thread_block == 0){
                ...
                for (int padding_number = 2; padding_number <= 16; padding_number++){
                        ...
                        altered_ct[local_bytes_read-padding] = reference_ct[local_bytes_read-padding]^XORkey;
                ...
                while (padding <= BLOCKLEN){
                        ...
                        for(int i = 1; i<=cipher_padding; i++){
                                altered_ct[local_bytes_read-i] = reference_ct[local_bytes_read-i]^cipher_padding^padding;
                        }
                        for(int i=(cipher_padding+1); i < padding; i++){
                                altered_ct[local_bytes_read-i] = reference_ct[local_bytes_read-i]^ptbuf[local_bytes_read-(IVLEN + MACLEN)-i-(thread_block*BLOCKLEN)]^padding;
                        }
                        ...
                        for (int common_index = 0; common_index <= 95; common_index++){
                                ...
                                // Make an altered ciphertext 
                                altered_ct[local_bytes_read-padding-(thread_block*BLOCKLEN)] = reference_ct[local_bytes_read-padding-(thread_block*BLOCKLEN)]^XORkey;
        ...
        /*********************************************************/
                ...
                while (padding <= BLOCKLEN){
                        ...
                        for(int i=1; i < padding; i++){
                                altered_ct[local_bytes_read-i-(thread_block*BLOCKLEN)] = reference_ct[local_bytes_read-i-(thread_block*BLOCKLEN)]^ptbuf[local_bytes_read-(IVLEN + MACLEN)-i-(thread_block*BLOCKLEN)]^padding;
                        }
